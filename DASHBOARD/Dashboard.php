...
<body>
    <div class="dashboard"> <!-- dashboard begins -->
        ...
        <section class="sidebar"><!-- sidebar begins -->
            ...
            <div class="icon3">
                <a href="#profile"> <span class="material-symbols-outlined"> person</span>
                    <p>Profile</p>
                </a>
            </div>

            <div class="icon4">
                <a href="#alumni"> <span class="material-symbols-outlined">groups</span>
                    <p>View Alumni </p>
                </a>
            </div>

            <div class="icon5">
                <a href="#events"> <span class="material-symbols-outlined">event </span>
                    <p> View Events </p>
                </a>
            </div>
